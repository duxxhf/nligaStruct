function [Q, W] = gaussQuadrature(noGpsX, noGpsY, noGpsZ)
%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%
...
if dim == 1    % one dimension
    [Q,W] = gaussLegendre(a,b,noGpsX);
    return;
end

if dim == 2    % two dimension
    [Q1,W1] = gaussLegendre(a,b,noGpsX);
    [Q2,W2] = gaussLegendre(a,b,noGpsY);
    n = 0;
    for j = 1:noGpsY
        for i = 1:noGpsX
            n = n+1;
...
if dim == 3     % three dimension
    [Q1,W1] = gaussLegendre(a,b,noGpsX);
    [Q2,W2] = gaussLegendre(a,b,noGpsY);
    [Q3,W3] = gaussLegendre(a,b,noGpsZ);
    n = 0;
    for k = 1:noGpsZ
        for j =1:noGpsY
            for i =1:noGpsX
