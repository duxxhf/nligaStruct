function plotKLshellCylinderResults(mesh,u,L)
%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%
%
% Plot displacement results of large deformation of the pulling cylinder
%  Input:
...
for i = 1:8
    ...
    %% Please uncomment the following codes to visualize Bezier elements
%     for j = 1:mesh.nElems
%         hold on;
...
h = colorbar;
t = get(h,'Limits');
set(h,'Ticks',linspace(t(1),t(2),13));
