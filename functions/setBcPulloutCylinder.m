function [dbc,sym_dbc,tbc,nodeA,nodeB,nodeC] = setBcPulloutCylinder(mesh,pLoad)
%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%
%
%  Set boundary conditions for kl shell (pullout of pinched cylinder) example
%  Input:
...
%    nodeC    - index number of control point C
%
%  ---------------------------------------
...
nodeC = rightNodes( abs(mesh.coords(rightNodes,2)-0)   < tol );
...
tbc = [tbc; forceNode,      3*ones(size(forceNode)),    pLoad*ones(size(forceNode))];
end
